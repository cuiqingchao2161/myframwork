...
public class CalendarReminderUtils {
    ...
    public static void addCalendarEvent(Context context, String title, String description, long reminderTime, int previousDate) {
        ...
        if (calId < 0) { //获取账户id失败直接返回，添加日历事件失败
            calId = addCalendarAccount(context);
        }
...
//        event.put(String.valueOf(CalendarContract.Events.CONTENT_URI), "www.baidu.com");
        event.put(CalendarContract.Events.EVENT_LOCATION, "上海盛夏路570号501");//
